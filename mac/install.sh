...
echo ""
echo "  Triggers:"
echo "    - On DNS/network change (resolv.conf watch — fires on most Wi-Fi connects but is not a precise trigger)"
...
echo ""
echo "  Repair:"
echo "    Re-run this installer if files, hooks, permissions, or background triggers break."
